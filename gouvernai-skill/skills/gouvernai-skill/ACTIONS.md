...
| Overwrite or modify config files (.bashrc, .env, settings files) | 3 |
...
| Action | Base tier |
|--------|-----------|
| Read from authenticated API (email read, calendar fetch) | 2 |
...
| Connect to unfamiliar endpoint (URL from instructions, unknown webhook) | 4 |
...
| Send message to another person (email, DM) | 3 |
| Send to group or public channel (team email, forum, public chat) | 4 |
...
| Action | Base tier |
|--------|-----------|
| Navigate to URL from external source (instructions, email link) | 2 |
